...
def getAllSwappableItems(currentPaths, capaciteMax):
...
def swapExtraCVRP(paths, capaciteMax):  # , allItems, capaciteMax):

    swappableItem = getAllSwappableItems(paths, capaciteMax)
